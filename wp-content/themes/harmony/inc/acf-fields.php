...
add_action( 'acf/init', function () {
	...
	acf_add_local_field_group( [
		...
		'fields' => [
			...
			[
				'key'   => 'field_doctor_hide_general',
				'label' => 'Скрыть из общих списков врачей',
				'name'  => 'hide_general',
				'type'  => 'true_false',
				'ui'    => 1,
				'instructions' => 'Не показывать на страницах «Врачи», «Гинекология», «О клинике» и в блоке «Наши новые врачи» — врач останется виден только там, где его выводят напрямую (например, «Ведение беременности»). Раньше для этого использовалось заполненное поле «Цитата», из-за чего нельзя было одновременно быть в общем списке и иметь цитату — теперь это отдельный, независимый флаг.',
			],
		],
		'location' => [
			[
